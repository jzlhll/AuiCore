...
L["Over"] = "包含过量"
L["Main Description"] = "这是一款死亡倒计时Buff,Debuff和受伤害统计插件，可以直观和快速地查看死亡前0s~60s的状态, 方便找出毒瘤。  Fixed By allan"
L["Max Damage Filtered amount"] = "伤害过滤数值的最大值"