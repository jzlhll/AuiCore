...
function EAFun_GroupEvent_GetValueFromFrameItem(FrameItemName, fIsDropdown)
	...
	if (aFrameItem ~= nil) then
		if (fIsDropdown) then
			sReturnValue = L_UIDropDownMenu_GetSelectedValue(aFrameItem);
		else
...
function EAFun_GroupEvent_LoadGroupEventToFrame(GroupID)
	...
	if (G_GroupItems.GlowWhenTrue) ~= nil then
		if (G_GroupItems.GlowWhenTrue) then EA_GroupEventSetting_Frame_GlowWhenTrue:SetChecked(true) end;
	end
...
function EAFun_GroupEvent_DropDown_OnLoad(DropDown, ItemValues, DefaultValue, ExtraInfo)
	...
	L_UIDropDownMenu_Initialize(DropDown, MyDropDownInit);
	L_UIDropDownMenu_SetSelectedValue(DropDown, DefaultValue);
...
function EAFun_GroupEvent_DropDown_OnClick(self, DropDown, DefaultValue, ExtraInfo)
	...
	L_UIDropDownMenu_SetSelectedValue(DropDown, SelValue);
	if (ExtraInfo ~= nil) then
		if (ExtraInfo.EventIndex == nil) then
...
function EAFun_GroupEvent_AddNewCheckBtn_Click(self)
	...
	if (CheckOpDropdown == nil) then
		CheckOpDropdown = CreateFrame("CheckButton", sCheckFramePrefix.."_CheckOpDropdown", CheckFrame, "L_UIDropDownMenuTemplate");
	end	-- Get GroupItem Value
		sDefaultValue = 1;
	...
	L_UIDropDownMenu_SetWidth(CheckOpDropdown, 60);
...
function EAFun_GroupEvent_AddNewSubCheckBtn_Click(self)
	...
	if (SubCheckOpDropdown == nil) then
		SubCheckOpDropdown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckOpDropdown", SubCheckFrame, "L_UIDropDownMenuTemplate");
	end	-- Get GroupItem Value
		sDefaultValue = 1;
	...
	L_UIDropDownMenu_SetWidth(SubCheckOpDropdown, 60);
	...
	if (SubCheckEventTypeDowndown == nil) then
		SubCheckEventTypeDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckEventTypeDowndown", SubCheckFrame, "L_UIDropDownMenuTemplate");
	end	-- Get GroupItem Value
	...
	L_UIDropDownMenu_SetWidth(SubCheckEventTypeDowndown, 210);
	...
	if (SubCheckUnitTypeDowndown == nil) then
		SubCheckUnitTypeDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckUnitTypeDowndown", SubCheckFrame, "L_UIDropDownMenuTemplate");
	end	-- Get GroupItem Value
	...
	L_UIDropDownMenu_SetWidth(SubCheckUnitTypeDowndown, 170);
		...
		if (iLoop ~= iShowEventIndex) then	
			...
			if (iLoop == 1) then
				...
				if (SubCheckPowerTypeDowndown == nil) then
					SubCheckPowerTypeDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckPowerTypeDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 0;
				...
				L_UIDropDownMenu_SetWidth(SubCheckPowerTypeDowndown, 90);
				...
				if (SubCheckPowerCompDowndown == nil) then
					SubCheckPowerCompDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckPowerCompDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 1;
				...
				L_UIDropDownMenu_SetWidth(SubCheckPowerCompDowndown, 60);
				...
				if (SubCheckPowerCompTypeDowndown == nil) then
					SubCheckPowerCompTypeDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckPowerCompTypeDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 1;
				...
				L_UIDropDownMenu_SetWidth(SubCheckPowerCompTypeDowndown, 75);
			...
			elseif (iLoop == 2) then
				...
				if (SubCheckHealthCompDowndown == nil) then
					SubCheckHealthCompDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckHealthCompDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 1;
				...
				L_UIDropDownMenu_SetWidth(SubCheckHealthCompDowndown, 60);
				...
				if (SubCheckHealthCompTypeDowndown == nil) then
					SubCheckHealthCompTypeDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckHealthCompTypeDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 1;
				...
				L_UIDropDownMenu_SetWidth(SubCheckHealthCompTypeDowndown, 75);
			...
			elseif (iLoop == 3) then
				...
				if (SubCheckAuraExistDowndown == nil) then
					SubCheckAuraExistDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckAuraExistDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 1;
				...
				L_UIDropDownMenu_SetWidth(SubCheckAuraExistDowndown, 75);
			...
			elseif (iLoop == 4) then
				...
				if (SubCheckComboCompDowndown == nil) then
					SubCheckComboCompDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckComboCompDowndown", SubEventFrame, "L_UIDropDownMenuTemplate");
				end	-- Get GroupItem Value
					sDefaultValue = 1;
				...
				L_UIDropDownMenu_SetWidth(SubCheckComboCompDowndown, 60);
...
function EAFun_GroupEvent_ChangeAuraCheck_Click(AuraCheck, ExtraInfo)
	...
	if (AuraCheck == 2) then	-- Hide this AuraCheckItems Frame
		...
		if (SubCheckTimeCompDowndown == nil) then
			SubCheckTimeCompDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckTimeCompDowndown", SubAuraCheckFrame, "L_UIDropDownMenuTemplate");
		end	-- Get GroupItem Value
			sDefaultValue = 1;
		...
		L_UIDropDownMenu_SetWidth(SubCheckTimeCompDowndown, 50);
		...
		if (SubCheckStackCompDowndown == nil) then
			SubCheckStackCompDowndown = CreateFrame("CheckButton", sSubCheckFramePrefix.."_SubCheckStackCompDowndown", SubAuraCheckFrame, "L_UIDropDownMenuTemplate");
		end	-- Get GroupItem Value
			sDefaultValue = 1;
		...
		L_UIDropDownMenu_SetWidth(SubCheckStackCompDowndown, 50);
...
function EventAlert_Options_AlertSoundSelect_OnLoad()	
	L_UIDropDownMenu_Initialize(EA_Options_Frame_AlertSoundSelect,EventAlert_Options_AlertSoundSelect_Initialize)	
	L_UIDropDownMenu_SetSelectedID(EA_Options_Frame_AlertSoundSelect, EA_Config.AlertSoundValue)	
	L_UIDropDownMenu_SetWidth(EA_Options_Frame_AlertSoundSelect, 130)
end


function EventAlert_Options_AlertSoundSelect_Initialize()
	
	local selectedValue = L_UIDropDownMenu_GetSelectedValue(EA_Options_Frame_AlertSoundSelect);
	if selectedValue == nil then selectedValue = 0 end;
...
function EventAlert_Options_AlertSoundSelect_OnClick(self)
	...
	L_UIDropDownMenu_SetSelectedValue(EA_Options_Frame_AlertSoundSelect, SelValue);
