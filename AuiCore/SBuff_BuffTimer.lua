...
local UnitAura, PlayerFrame = UnitAura, PlayerFrame
...
local function resetBuffValues()
    _163BuffValues = nil
    _163BuffValues = {}
    _163BuffValues["largeDebuffSize"] = 14
    _163BuffValues["smallDebuffSize"] = 10
    _163BuffValues["largeBuffSize"] = 14
    _163BuffValues["smallBuffSize"] = 10
    _163BuffValues["targetBuffCooldownCount"] = 14
    _163BuffValues["targetDebuffCooldownCount"] = 10
    _163BuffValues["hideNameplateDebuff"] = true
    _163BuffValues["cvar_buffDurations/buffSize"] = 12
end
